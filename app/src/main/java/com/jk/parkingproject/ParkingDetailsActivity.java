...
//        loadParkingInfoDetails();
    ...
    private void editParking() {
        ...
        Log.e(TAG, "editParking: Before Intent PARKIND ID FROM INTENT"+getIntent().getStringExtra("parkingId"));
        Log.e(TAG, "editParking: Before Intent"+currentParking.toString() );
